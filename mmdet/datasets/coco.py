            ...
            if metric == 'proposal':
                ...
                if classwise:  # Compute per-category AP
                    ...
                    for idx, catId in enumerate(self.cat_ids):
                        ...
                        #----------- precisions: [IoUThr, Sample, Cat, Area, MaxDet]
                    ...
                    for idx, catId in enumerate(self.cat_ids):
                        ...
                        if precision.size:
                            ...
                            ap = float('nan')
                        results_per_category_mAP.append(
                            (f'{nm["name"]}', f'{float(ap):0.3f}'))
                    ...
                    eval_results['results_per_category_mAP'] = results_per_category_mAP
                    ######################
